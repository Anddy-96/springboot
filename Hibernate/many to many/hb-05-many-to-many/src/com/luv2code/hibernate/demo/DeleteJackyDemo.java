	...
	public static void main(String[] args) {
		...
		try {
			...
			int id = 1;
			 ...
			 System.out.println("jacky student: "+tempc);
			 
			 System.out.println("courses of jacky: "+tempc.getCourses());
			
			 //delete the student
			 System.out.println("deleting the student jacky");
